---
title: Introduction
excerpt: "About me, my intentions, and my feelings on starting a blog."
layout: "blog-post"
url_crying: "https://wearecrying.bandcamp.com/album/beyond-the-fleeting-gales"
---
...
- [Crying](https://wearecrying.bandcamp.com/album/beyond-the-fleeting-gales){:target="_blank"}
- [Smiling Broadly](https://smilingbroadly.bandcamp.com/album/smiling-broadly-ep){:target="_blank"} *(fka Twinkle Park)*
- [Nobonoko](https://nobonoko.bandcamp.com/album/how-many-cats-are-in-this-picture){:target="_blank"}
- A series of DnB mixes on YouTube entitled ["Ya Like Jazz"](https://www.youtube.com/watch?v=mupsjddCat4){:target="_blank"}
- [Aphex Twin](https://aphextwin.bandcamp.com/album/drukqs){:target="_blank"}
- [Axolotes Mexicanos](https://axolotesmexicanosmusic.bandcamp.com/album/salu2){:target="_blank"}
- [Kero Kero Bonito](https://kerokerobonito.bandcamp.com/album/time-n-place){:target="_blank"}
- *The Cure* *(you don't need a link for The Cure lol)*
- *Elliot Smith* *(same for Elliot Smith)*
- [Men I Trust](https://menitrust.bandcamp.com/album/equus-caballus){:target="_blank"}
- [Sufjan Stevens](https://sufjanstevens.bandcamp.com/album/illinois){:target="_blank"}
- [Weyes Blood](https://weyesblood.bandcamp.com/album/titanic-rising){:target="_blank"}

I try to always be seeking out new-to-me music so if you stick around, this list will be pretty different in a few months.

## Linux <img justify="center" style="height: 35px; width: 45px;" src="/assets/imgs/inline/nerd-emotiguy.png" alt="nerd emote">

I am a Linux enjoyer and have been daily driving it for about 6 years. I first got into it in middle school when my older brother's friend Chauncey, the local enthusiast, helped my dad out by slapping Ubuntu onto some bottom-of-the-line, outdated PCs that he had laying around (sense memory: *the crunch of old hard drives working in overdrive*). I was blown away by it. Not for any interesting technical reason, but because I had never used a computer that wasn't running Windows. It was a genuine novelty to see things like a taskbar on the side of the screen or different looking icons, and I was really enchanted by the simplicity of installing programs with a command line instead of a downloaded installer. I was prettily easily impressed. Later, he stayed up with me until like 2 in the morning, walking me through an Arch install (in retrospect, I don't know why he thought I was ready for Arch at that point). It’s a really fond memory, though only a couple weeks later I would put Windows right back on my PC because I couldn't get FL Studio to run well via Wine.
...
There might be some occasional Linux posts because it is a never-ending rabbit-hole, but you can skip them if that's not your bag. If you *are* into Linux, check out a Linux YouTuber I've been really digging lately, [Bread on Penguins](https://www.youtube.com/@BreadOnPenguins). Her videos are straight to the point and her channel is very human.
...
My current pet project is a little app that helps create language learning flashcards for [anki](https://apps.ankiweb.net/){:target="_blank"}. The idea is that you give it a word or phrase in your target language and it will fetch images, pronunciations, and translations that you can choose from to assemble your ideal flashcard. Then you can export your cards and add them to an anki deck. I've got image fetching and the GUI built but that's about it so far.
...
[^1]: Incidentally, this year I *did* add a Windows boot back, but only because I wanted to play Oblivion and I couldn't be assed to get it to work on Arch. Gotta pick your battles. ¯\\_(ツ)_/¯
